...
{
    public class CallbackController : ZSingletonBehaviour<CallbackController>
    {
        ...
        public void RegisterUpdateEvent(string uid,UnityAction callback)
        {
            ...
            {
                Debug.LogWarning("Callback Controller... had register uid = " + uid);
                return;
            }
        ...
        public void RegisterUpdateEvent(GameObject target, UnityAction callback)
        {
            ...
            if (HasUpdateEvent(target)) {
                Debug.LogWarning("Callback Controller... had register target = "+target);
                return;
            }
