...
using ZStart.Core.ZLib.Encryption;
using ZStart.Core.Zlib;
#endif

namespace ZStart.Core.ZLib.Zip.Compression.Streams
{
    /// <summary>
    ...
    public class DeflaterOutputStream : Stream
	{
		...
		public virtual void Finish()
		{
			...
			if (!deflater_.IsFinished) {
				throw new ZipBaseException("Can't deflate all input?");
			}
		...
		protected void Deflate()
		{
			...
			if (!deflater_.IsNeedingInput) {
				throw new ZipBaseException("DeflaterOutputStream can't deflate all input?");
			}
		}
		#endregion
